...
a persistence unit "MiPracticaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "MiPractica\pom.xml":
...
artifact ("MiPractica.war") is already built. You can build
