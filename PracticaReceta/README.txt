...
a persistence unit "PracticaRecetaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PracticaReceta\pom.xml":
...
artifact ("PracticaReceta.war") is already built. You can build
