...
a persistence unit "FacturaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Factura\pom.xml":
...
artifact ("Factura.war") is already built. You can build
