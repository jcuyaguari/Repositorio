...
a persistence unit "ConsultorioPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Consultorio\pom.xml":
...
artifact ("Consultorio.war") is already built. You can build
