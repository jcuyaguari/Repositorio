...
a persistence unit "ServerPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Server\pom.xml":
...
artifact ("Server.war") is already built. You can build
