...
a persistence unit "agendatelefonicaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "agendatelefonica\pom.xml":
...
artifact ("agendatelefonica.war") is already built. You can build
